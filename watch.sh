...
while [ $duration -gt 0 ]; do
	...
	ffmpeg -f v4l2 -thread_queue_size 1024 -input_format nv12 -video_size 1024x768 -framerate 30 -i /dev/video0 -c:v h264_v4l2m2m -b:v 2.5M -t $segment ./working/video-current.mp4
